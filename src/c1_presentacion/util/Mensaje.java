...
public class Mensaje {
    ...
    private static final String combo = "Seleccione ";
    public static final String cboMsgGenero = combo + "un Genero";
    public static final String cboMsgDepartamento = combo + "un Departamento";
    public static final String cboMsgProvincia = combo + "una Provincia";
    public static final String cboMsgDistrito = combo + "un Distrito";
    public static final String cboMsgNacionalidad = combo + "una Nacionalidad";
    public static final String cboMsgTipoDocumento = combo + "un Tipo Documento";
    ...
    public static void mostrarErrorDeConsulta(JDialog dialogo){
        JOptionPane.showMessageDialog(dialogo,errorDeConsulta,"EV-Soft: Error",JOptionPane.ERROR_MESSAGE);
    }
    ...
    public static void mostrarFilaNoSeleccionada(JDialog dialogo){
        JOptionPane.showMessageDialog(dialogo,filaNoSeleccionada,"EV-Soft: Advertencia",JOptionPane.WARNING_MESSAGE);
    }
    ...
    public static void mostrarFilaNoExiste(JDialog dialogo){
        JOptionPane.showMessageDialog(dialogo,filaNoExiste,"EV-Soft: Advertencia",JOptionPane.WARNING_MESSAGE);
    }
    ...
    public static boolean mostrarPreguntaDeEliminacion(JDialog dialogo){
        int respuesta = JOptionPane.showConfirmDialog(dialogo,preguntaDeEliminacion,"EV-Soft: Pregunta",JOptionPane.YES_NO_OPTION);
    ...
    public static void mostrarAfirmacionDeEliminacion(JDialog dialogo){
        JOptionPane.showMessageDialog(dialogo,afirmacionDeEliminacion,"EV-Soft: Mensaje",JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public static void mostrarAdvertenciaDeEliminacion(JDialog dialogo){
        JOptionPane.showMessageDialog(dialogo,advertenciaDeEliminacion,"EV-Soft: Advertencia",JOptionPane.WARNING_MESSAGE);
    }
    ...
    public static void mostrarErrorDeEliminacion(JDialog dialogo){
        JOptionPane.showMessageDialog(dialogo,errorDeEliminacion,"EV-Soft: Error",JOptionPane.ERROR_MESSAGE);
    }
    ...
    public static void mostrarAfirmacionDeCreacion(JDialog dialogo){
        JOptionPane.showMessageDialog(dialogo,afirmacionDeCreacion,"EV-Soft: Mensaje",JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public static void mostrarAdvertenciaDeCreacion(JDialog dialogo){
        JOptionPane.showMessageDialog(dialogo,advertenciaDeCreacion,"EV-Soft: Advertencia",JOptionPane.WARNING_MESSAGE);
    }
    ...
    public static void mostrarErrorDeCreacion(JDialog dialogo){
        JOptionPane.showMessageDialog(dialogo,errorDeCreacion,"EV-Soft: Error",JOptionPane.ERROR_MESSAGE);
    }
    ...
    public static void mostrarAfirmacionDeActualizacion(JDialog dialogo){
        JOptionPane.showMessageDialog(dialogo,afirmacionDeActualizacion,"EV-Soft: Mensaje",JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public static void mostrarAdvertenciaDeActualizacion(JDialog dialogo){
        JOptionPane.showMessageDialog(dialogo,advertenciaDeActualizacion,"EV-Soft: Advertencia",JOptionPane.WARNING_MESSAGE);
    }
    ...
    public static void mostrarErrorDeActualizacion(JDialog dialogo){
        JOptionPane.showMessageDialog(dialogo,errorDeActualizacion,"EV-Soft: Error",JOptionPane.ERROR_MESSAGE);
    }
    ...
    public static void mostrarAfirmacion(JDialog dialogo, String mensaje){
        JOptionPane.showMessageDialog(dialogo,mensaje,"EV-Soft: Mensaje",JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public static void mostrarAdvertencia(JDialog dialogo, String mensaje){
        JOptionPane.showMessageDialog(dialogo,mensaje,"EV-Soft: Advertencia",JOptionPane.WARNING_MESSAGE);
    }
    ...
    public static void mostrarError(JDialog dialogo, String mensaje){
        JOptionPane.showMessageDialog(dialogo,mensaje,"EV-Soft: Error",JOptionPane.ERROR_MESSAGE);
    }
}
